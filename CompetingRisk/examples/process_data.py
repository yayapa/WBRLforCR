...
x, t, e, covariates = datasets.load_dataset(dataset, normalize=False, competing = True, drop_first = True) 
...
for i, (train_index, test_index) in enumerate(kf.split(x, e)):
    ...
    fold = pd.Series(0, index = data.index, dtype=object)
